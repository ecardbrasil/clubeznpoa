...
export function SobrePageClient({ featuredOffers, partnerProfiles }: Props) {
  return (
        ...
        <div className="relative z-10 grid w-full max-w-7xl gap-12 px-4 py-16 mx-auto md:gap-16 md:px-6 md:py-24">
          ...
          >
            {[
              ...
              { value: "24h", label: "Resgate rápido" },
              { value: "0%", label: "Taxa para usar" },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="text-2xl font-black text-[#0a0f0c]" style={{ fontFamily: "var(--font-poppins)" }}>{stat.value}</p>
                <p className="text-xs text-[#556b61] uppercase tracking-wide">{stat.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <footer className="grid gap-8 border-t border-[#e7eddc] bg-white p-8 md:p-12">
          ...
          <div className="flex flex-col gap-4 border-t border-[#e7eddc] pt-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-6">
              <Link href="/ofertas" className="text-sm font-semibold text-[#0a0f0c] no-underline hover:text-[#C9F549] transition-colors">Ofertas</Link>
              <Link href="/parceiros" className="text-sm font-semibold text-[#0a0f0c] no-underline hover:text-[#C9F549] transition-colors">Parceiros</Link>
              <Link href="/como-funciona" className="text-sm font-semibold text-[#0a0f0c] no-underline hover:text-[#C9F549] transition-colors">Como funciona</Link>
              <Link href="/auth" className="text-sm font-semibold text-[#0a0f0c] no-underline hover:text-[#C9F549] transition-colors">Entrar</Link>
            </div>
          </div>
        </footer>
      </div>
